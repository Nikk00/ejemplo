...
<header>
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			<div id="logo">
				<h1 class="mt-md-0 mt-2"> <a href="/"><span class="fa fa-map-signs"></span> Grand Tour </a></h1>
			</div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 contact-left-form">
						<form action="{{route('mensajes')}}" method="post">
							...
							<div class="form-group contact-forms">
							  <input name="fono" type="text" class="form-control" placeholder="Phone" required=""> 
							</div>
							<div class="form-group contact-forms">
							  <textarea name="body" class="form-control" placeholder="Message" rows="3" required=""></textarea>
							</div>
...
<!-- map -->	
<div class="map p-2">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d467.8810377370236!2d-70.1263382385347!3d-20.25683144109876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91521461eaeffe6f%3A0x48b22410a01edc47!2sPlaya+Quintero+3512%2C+Iquique%2C+Regi%C3%B3n+de+Tarapac%C3%A1!5e0!3m2!1ses-419!2scl!4v1560982492897!5m2!1ses-419!2scl" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
<!-- //map -->
